...
var mmmaM22Schema = Schema({//esquema de la estructura que va a tener el formulario
    ...
    //1. MANTENIMIENTO DE PORTICO CENTRAL
...
module.exports = mongoose.model('mmmaM22', mmmaM22Schema);