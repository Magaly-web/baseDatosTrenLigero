...
var mmmaM21Schema = Schema({//esquema de la estructura que va a tener el formulario
    ...
    //1. MANTENIMIENTO SALON PASAJEROS
...
module.exports = mongoose.model('mmmaM21', mmmaM21Schema);